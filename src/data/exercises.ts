import { EDITING_EXERCISES } from './editing-exercises';

export type ExerciseType = 'spelling' | 'dictation' | 'editing' | 'vocab' | 'grammar';
...
export interface Exercise {
    ...
    dictation: string;
    editing?: string; // string containing the passage with markup
}
